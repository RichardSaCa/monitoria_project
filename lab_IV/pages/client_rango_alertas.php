...
<meta charset="UTF-8">
    ...
    <title>Rangos de medición</title>
</head>
<body>
    ...
    <div class="contenedor_formR">
        <form action="../logic/client_rango_alertasLogic.php" method="POST">
            ...
            <?php
                ...
                ON datos_maximos.ID_BIODIGESTOR = biodigestor.ID_BIODIGESTOR WHERE biodigestor.ID_USUARIO = $id_cliente ORDER BY datos_maximos.ID_BIODIGESTOR ASC";
            ...
            <div class="contenedor_opciones">
                ...
                <div class="contenedor_temp">
                    ...
                    <input type="number" name="temp_max" min="50" max="99" required>
                    <label for="temp_min">Temperatura Mínima</label>
                    <input type="number" name="temp_min" min="0" max="15" required>
                </div>
            </div>
            <div class="contenedor_opciones">
                ...
                <div class="contenedor_hum">
                    ...
                    <input type="number" name="hum_max" min="50" max="99" required>
                    <label for="hum_min">Humedad Mínima</label>
                    <input type="number" name="hum_min" min="0" max="15" required>
                </div>
            </div>
