...
<body>
    ...
    <div class="contenedor_integrantes">
        ...
        <div class="integrantes_group2">
            ...
            Oscar Andrés Muñoz Jimenez, Estudiante de Ingeniería Electrónica y Telecomunicaciones, Tecnólogo en Telecomunicaciones, Aspiraciones: crear una empresa de seguridad, que implemente diferentes tecnologías de comunicación.
            </div>
        </div>
        <div class="integrantes_group">
            <div class="contenedor_foto">
        ...
        <div class="integrantes_group2">
            ...
            <div class="contenedor_descripcion2">
                    Andrés Felipe Hurtado Zúñiga, estudiante de septimo semestre de Ingeniería Electrónica y Telecomunicaciones de la Universidad del Cauca. Amante del deporte y desarrollo web.
            </div>
        </div>
        <div class="integrantes_group">
            <div class="contenedor_foto">
            ...
            <div class="contenedor_descripcion">
                    Edier Dario Bravo, estudiante de octavo semestre de Ingeniería Electrónica y Telecomunicaciones de la Universidad del Cauca
            </div>
        </div>
        <div class="integrantes_group2">
            <div class="contenedor_foto2">
            ...
            <div class="contenedor_descripcion2">
                    Richard Sanchez Caicedo, estudiante de octavo semestre de Ingeniería Electrónica y Telecomunicaciones
            </div>
        </div>
